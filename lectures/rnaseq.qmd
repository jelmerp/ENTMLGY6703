...
Functional enrichment analyses check whether certain **functional categories of genes**
are **statistically overrepresented** among up- and/or downregulated genes.
...
-   Highest-level grouping are the three "ontologies": _Biological Process_, _Molecular Function_, _Cellular Component_
...
"KEGG representation of up-regulated genes related to jasmonic acid (JA) signal transduction pathways (ko04075) in banana cv. Calcutta 4 after inoculation with _Pseudocercospora fijiensis_. Genes or chemicals up-regulated at any time point were highlighted in green."
:::
